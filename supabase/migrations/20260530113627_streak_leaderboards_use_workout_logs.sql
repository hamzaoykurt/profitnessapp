-- Keep streak leaderboards aligned with the app's visible daily streak.
-- The app treats workout_logs.date as the source of truth for streak days.
-- set_completions may include historical or draft set rows and can over-count.
